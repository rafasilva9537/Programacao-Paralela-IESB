...
int main() {
    ...
    // Tempo TOTAL (s): 2.19608
    // Equações com raízes reais: 25000000
    // Equações sem raízes reais: 25000000

    // Comparado com a versão com critical na soma das variáveis "nao_possuem_raizes" e "possuem_raizes", há um ganho bem significativo
    // Foi de 11.060 para 2.19608 segundos    
