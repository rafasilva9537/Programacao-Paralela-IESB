...
int main() {
    ...
    // Tempo TOTAL (s): 8.44275
    // Equações com raízes reais: 25000000
    // Equações sem raízes reais: 25000000

    // Comparado a versão que usa atomic (arquivo "exercicios_07_10/002_atomic.cpp")
    // Mesmo desconsiderando o tempo de alocação, ainda demora bem mais que usar o atomic
    // Foi de 2.19608 para 8.44275 segundos
